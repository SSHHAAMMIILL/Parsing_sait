...
def get_source_html(url):
    ...
    with open("ESC_бесколлект.html", "w") as file:
        file.write(src)
...
def get_source_html_array(url,name,n):
    ...
    with open(f"link_ESC/{n}_{name}.html", "w") as file:
        file.write(src)


def motors(name, d):
    print(name)
    with open(f"link_ESC/{d}_{name}.html") as file:
        src = file.read()
...
def main():
    ...
    with open("ESC_бесколлект.html") as file:
        src = file.read()
